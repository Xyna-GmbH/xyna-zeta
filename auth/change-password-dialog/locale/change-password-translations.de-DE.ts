...
export const changePassword_translations_de_DE: I18nTranslation[] = [
    {
    ...
    },
    {
        ...
        value: 'Kennwort entspricht nicht den Anforderungen'
    },
    {
        key: 'zeta.auth.change-password.confirmPassword',
        value: 'Kennwort bestätigen'
    },
    {
        key: 'zeta.auth.change-password.confirmPassword.error',
        value: 'Kennwörter stimmen nicht überein'
    },
    {
        key: 'zeta.auth.change-password.hint',
        value: 'Das neue Kennwort muss der folgenden Regel entsprechen: $0'
    },
    {
        key: 'zeta.auth.change-password.error.unauthorized',
        value: 'Das alte Kennwort ist falsch.'
    },
    {
